...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		module.exports = factory((function webpackLoadOptionalExternalModule() { try { return __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'sharp'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())); } catch(e) {} }()), (function webpackLoadOptionalExternalModule() { try { return __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'canvas'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())); } catch(e) {} }()), (function webpackLoadOptionalExternalModule() { try { return __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'electron/common'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())); } catch(e) {} }()));
...
const ocr = new (alt1_chatbox__WEBPACK_IMPORTED_MODULE_0___default())();
...
const manualTriggerSafe = (idx) => {
    safeLocations[idx].available = safeLocations[idx].start;
};
const deleteSafeLocation = (idx) => {
    safeLocations.splice(idx, 1);
    redraw();
};
const changeNoteFor = (idx, text) => {
...
const t = setInterval(function () {
    try {
        ...
        safeLocations.forEach((loc, idx) => {
            const currentProgress = document.getElementById(`progress-${idx}`);
